...
export function PainFollowUpEditor({ caseId, encounter, initialNote, seriesOptions=[] }: { caseId:string; encounter:Tables<'clinical_encounters'>; initialNote:Tables<'pain_follow_up_notes'>|null; seriesOptions?:ProcedureSeriesOption[] }) {

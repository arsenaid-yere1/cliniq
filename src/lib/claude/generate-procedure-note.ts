...
PRE-PROCEDURE SAFETY CHECKLIST (MANDATORY): Every procedure-note subjective should include a brief safety-clearance sentence immediately before (or after) the pain-rating sentence. Use this exact language when the chart does not document otherwise: "He [or she] has ${NSAID_HELD_CLAUSE} and denies fever, bleeding diathesis, recent anticoagulant use, or new neurological complaints." If any of those fields IS documented separately on the input data, incorporate the actual status; otherwise emit the boilerplate above unchanged — it represents the standard pre-procedure safety clearance and will be reviewed/edited by the clinician before finalization. Do NOT split this into a separate section; keep it in the subjective paragraph. Do NOT emit bracketed placeholders for these safety elements — they are standard clinical clearance that the clinician has performed even when not separately captured in the structured data.

Reference (paintoneLabel="baseline", first injection): "Mr. Vardanyan is a 45-year-old male who returns today for his scheduled PRP injection to the lumbosacral region. He reports ongoing low back pain with functional limitations, including difficulty with prolonged sitting at work and with driving. Pain is rated 6-7/10. He has ${NSAID_HELD_CLAUSE} and denies fever, bleeding diathesis, recent anticoagulant use, or new neurological complaints."
Reference (paintoneLabel="improved", one prior): "Mr. Vardanyan is a 45-year-old male who returns for his scheduled follow-up PRP injection to the lumbosacral region. He reports mild improvement in his low back pain and function following the initial injection. Residual pain is intermittent and rated 3-4/10, compared to 6/10 at his last visit. Since the prior injection he notes improved tolerance for sitting at work and partial improvement in sleep quality, with fewer nocturnal awakenings. Post-procedure soreness from the prior session resolved within approximately 48 hours. The patient reports no adverse events and no red-flag symptoms. He has ${NSAID_HELD_CLAUSE} and denies fever, bleeding diathesis, recent anticoagulant use, or new neurological complaints."
Reference (paintoneLabel="stable", one prior): "Mr. Vardanyan is a 45-year-old male who returns for his scheduled follow-up PRP injection to the lumbosacral region. Symptoms remain largely unchanged since the prior injection, with modest day-to-day variability. Pain is rated 5-6/10, compared to 6/10 at his last visit. Functional tolerance for sitting and driving remains similar to the prior visit, and sleep disturbance is unchanged. Post-procedure soreness from the prior session resolved within approximately 48 hours. The patient reports no adverse events and no red-flag symptoms. He has ${NSAID_HELD_CLAUSE} and denies fever, bleeding diathesis, recent anticoagulant use, or new neurological complaints."
Reference (paintoneLabel="worsened", one prior): "Mr. Vardanyan is a 45-year-old male who returns for his scheduled follow-up PRP injection to the lumbosacral region. He reports persistent low back pain with ongoing functional limitations despite the initial injection, including continued difficulty with prolonged sitting and disrupted sleep. Pain is rated 7-8/10, compared to 6/10 at his last visit. Post-procedure soreness from the prior session resolved within approximately 48 hours. The patient reports no adverse events and no red-flag symptoms. He has ${NSAID_HELD_CLAUSE} and denies fever, bleeding diathesis, recent anticoagulant use, or new neurological complaints."
Reference (paintoneLabel="improved", 2+ prior — trajectory narrative): "Ms. Taylor is a 34-year-old female who returns for her scheduled PRP injection to the cervical spine. She reports sustained improvement in neck pain across the injection series; pain has progressively decreased from 8/10 → 5/10 → 3/10. Current pain is rated 2-3/10, compared to 5/10 at her last visit. She notes improved tolerance for working at her desk and improved sleep quality since the prior injections. Post-traumatic headaches have reduced in frequency. Post-procedure soreness from the prior session resolved within approximately 48 hours, with no adverse events and no red-flag symptoms. Overall, the cumulative trajectory of response to the PRP series remains favorable. She has ${NSAID_HELD_CLAUSE} and denies fever, bleeding diathesis, recent anticoagulant use, or new neurological complaints."
...
Reference (single-site): "Under ultrasound guidance, a 25-gauge spinal needle was inserted into the facet joint, targeting the most affected area as visualized on prior imaging. The PRP solution (5 mL) was injected slowly into the joint to maximize distribution and tissue saturation. The needle was withdrawn, and sterile gauze was applied to the injection site. No complications, such as bleeding or infection, were noted."
...
Reference (multi-site, total volume null, spine): "Under ultrasound guidance, a 25-gauge spinal needle was inserted at each treated level. The PRP solution was distributed across L4-L5 and L5-S1; [confirm total volume in mL], with allocation calibrated to the pathology burden at each level. The needle was withdrawn at each site, and sterile gauze was applied to the injection sites. No complications, such as bleeding or infection, were noted."
...
(B) Myelopathy and cord-compromise codes — require documented upper motor neuron signs OR (for stenosis codes) documented neurogenic claudication with objective lower-extremity findings. Omit the following codes unless the objective_physical_exam on this visit's input data documents the required evidence: M50.00, M50.01, M50.02, M47.1X, M54.18, M48.0X (spinal stenosis codes when billed with a neurogenic claudication / myelopathy qualifier), and M47.2X variants carrying a myelopathy qualifier. Required evidence for myelopathy codes (M50.0X, M47.1X, M54.18): at least one of hyperreflexia, clonus, Hoffmann sign, Babinski sign, spastic gait, or bowel/bladder dysfunction. Required evidence for M48.0X with neurogenic claudication: documented positional lower-extremity pain/weakness with a standing/walking exacerbation pattern AND an objective lower-extremity finding (dermatomal deficit, myotomal weakness, or diminished reflex). Isolated subjective paresthesia, intact sensation, symmetric 2+ reflexes, and 5/5 strength do NOT support any code in this set. When omitting a myelopathy/cord-compromise code, do not substitute — the underlying disc pathology is already captured by non-myelopathy disc codes (see below); M48.0X may be downgraded to the matching non-myelopathy stenosis or disc-degeneration code (e.g., M51.36/M51.37) per the Downgrade Table.
